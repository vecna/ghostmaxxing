...
Standalone page scripts include `loader.js` for repeatable MP4/video fixture analysis, `mobile-ui.js` for mobile drawer/fullscreen controls, `lab-ui.js` for shared lab-page UI wiring, `export-makeup.js` for PNG clipboard/share export, and `upload-consent.js` for the local clip consent and receipt flow.
