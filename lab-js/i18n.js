...
export const messages = {
   transfer_page_title: {
      context: 'ghostyle-transfer.html:7; lab-js/transfer.js:143',
   ...
   transfer_engine_loading: {
      context: 'ghostyle-transfer.html:60; lab-js/transfer.js:26',
   ...
   transfer_engine_unavailable: {
      context: 'lab-js/transfer.js:160',
   ...
   transfer_engine_ready: {
      context: 'lab-js/transfer.js:169',
   ...
   transfer_engine_failed: {
      context: 'lab-js/transfer.js:171',
   ...
   transfer_msg_load_after_target: {
      context: 'ghostyle-transfer.html:150; lab-js/transfer.js:27; lab-js/transfer.js:337',
   ...
   transfer_msg_ready: {
      context: 'lab-js/transfer.js:337',
   ...
   transfer_msg_done: {
      context: 'lab-js/transfer.js:753',
      it: 'Fatto.',
      en: 'Done.',
      pt: 'Concluido.',
   },
   transfer_msg_error: {
      context: 'lab-js/transfer.js:807',
      it: 'Errore: {message}',
      en: 'Error: {message}',
      pt: 'Erro: {message}',
   },
   transfer_note_box_set: {
      context: 'lab-js/transfer.js:316',
      it: 'riquadro volto impostato',
      en: 'face box set',
      pt: 'caixa do rosto definida',
   },
   transfer_note_draw_box: {
      context: 'lab-js/transfer.js:318',
   ...
   transfer_mode_not_run: {
      context: 'ghostyle-transfer.html:166; lab-js/transfer.js:28',
      it: 'Non ancora eseguito.',
      en: 'Not run yet.',
      pt: 'Ainda nao executado.',
   },
   transfer_mode_placed: {
      context: 'lab-js/transfer.js:103',
      it: 'Posizionato con: {mode}',
      en: 'Placed using: {mode}',
      pt: 'Posicionado usando: {mode}',
   },
   transfer_mode_box: {
      context: 'lab-js/transfer.js:697',
      it: 'riquadro',
      en: 'box',
      pt: 'caixa',
   },
   transfer_mode_mesh: {
      context: 'lab-js/transfer.js:736',
   ...
   save_your_face_status: {
      context: 'lab.html:63; lab-js/lab-ui.js:295',
   ...
   upload_meta_recorded_label: {
      context: 'lab-js/upload-consent.js',
      it: 'Registrata',
      en: 'Recorded',
      pt: 'Gravado',
   },
   ...
   not_available_label: {
      context: 'lab-js/dom.js:123',
      it: 'N/D',
      en: 'N/A',
      pt: 'N/D',
   },
   off_status: {
      context: 'lab-js/dom.js:124',
      it: 'off',
      en: 'off',
      pt: 'off',
   },
   ...
   mirror_webcam_on_status: {
      context: 'lab-js/main.js:42; lab-js/camera.js:71',
   ...
   error_console_prefix: {
      context: 'lab-js/main.js:162',
      it: 'Errore:',
      en: 'Error:',
      pt: 'Erro:',
   },
   face_thumbnail_alt: {
      context: 'lab-js/main.js:296',
      it: 'Miniatura volto ID {id}',
      en: 'Face thumbnail ID {id}',
      pt: 'Miniatura do rosto ID {id}',
   },
   no_preview: {
      context: 'lab-js/main.js:302; lab-js/analyze-panel.js:138',
      it: 'nessuna anteprima',
      en: 'no preview',
      pt: 'sem prévia',
   },
   delete_id_label: {
      context: 'lab-js/main.js:334; lab-js/main.js:346; lab-js/main.js:350',
      it: 'Cancella ID {id}',
      en: 'Delete ID {id}',
      pt: 'Excluir ID {id}',
   },
   confirm_delete_id_label: {
      context: 'lab-js/main.js:355; lab-js/main.js:356',
      it: 'Conferma cancellazione ID {id}',
      en: 'Confirm deletion of ID {id}',
      pt: 'Confirmar exclusão do ID {id}',
   },
   no_saved_faces_empty: {
      context: 'lab-js/main.js:381',
      it: 'Nessun volto salvato.',
      en: 'No saved faces.',
      pt: 'Nenhum rosto salvo.',
   },
   confirm_question: {
      context: 'lab-js/main.js:542; lab-js/main.js:546; lab-js/main.js:548',
      it: 'Conferma?',
      en: 'Confirm?',
      pt: 'Confirmar?',
   },
   loading_face_system_log: {
      context: 'lab-js/main.js:556',
   ...
   match_2d_ghostyle_unclear_headline: {
      context: 'lab-js/landmark-analysis.js:134',
   ...
   match_2d_detector_failed_headline: {
      context: 'lab-js/landmark-analysis.js:142',
   ...
   match_2d_weak_detection_headline: {
      context: 'lab-js/landmark-analysis.js:150',
   ...
   match_2d_ghostyle_eluded_headline: {
      context: 'lab-js/landmark-analysis.js:159',
   ...
   match_2d_live_matched_headline: {
      context: 'lab-js/landmark-analysis.js:169',
   ...
   match_2d_live_eluded_headline: {
      context: 'lab-js/landmark-analysis.js:178',
   ...
   webcam_live_status: {
      context: 'lab-js/camera.js:79',
      it: 'webcam attiva',
      en: 'webcam active',
      pt: 'webcam ativa',
   },
   webcam_active_log: {
      context: 'lab-js/camera.js:80',
   ...
   image_embedder_ready_log: {
      context: 'lab-js/engine-3d.js:63',
   ...
   image_embedder_not_loaded_error: {
      context: 'lab-js/engine-3d.js:105',
   ...
   no_embedding_returned_error: {
      context: 'lab-js/engine-3d.js:110',
   ...
   embedding_extraction_error: {
      context: 'lab-js/engine-3d.js:115',
   ...
   image_embedder_not_ready_save_log: {
      context: 'lab-js/engine-3d.js:152',
   ...
   db_3d_not_initialized_log: {
      context: 'lab-js/engine-3d.js:156',
   ...
   embedding_extraction_log: {
      context: 'lab-js/engine-3d.js:163',
   ...
   image_embedder_saved_log: {
      context: 'lab-js/engine-3d.js:172',
   ...
   image_embedder_not_ready_compare_log: {
      context: 'lab-js/engine-3d.js:267',
   ...
   live_embedding_extraction_log: {
      context: 'lab-js/engine-3d.js:278',
   ...
   match_3d_ghostyle_matched_headline: {
      context: 'lab-js/engine-3d.js:316',
   ...
   match_3d_ghostyle_eluded_headline: {
      context: 'lab-js/engine-3d.js:321',
   ...
   match_3d_empty_db_headline: {
      context: 'lab-js/engine-3d.js:327',
   ...
   match_3d_live_matched_headline: {
      context: 'lab-js/engine-3d.js:332',
   ...
   match_3d_live_eluded_headline: {
      context: 'lab-js/engine-3d.js:337',
   ...
   escaped_status: {
      context: 'lab-js/lab-ui.js:344; lab-js/lab-ui.js:364',
      it: 'Escapou',
      en: 'Escaped',
      pt: 'Escapou',
   },
   recognised_status: {
      context: 'lab-js/lab-ui.js:345; lab-js/lab-ui.js:364',
      it: 'Reconhecido',
      en: 'Recognised',
      pt: 'Reconhecido',
   },
   visual_comparison_title: {
      context: 'lab-js/analyze-panel.js:142',
      it: 'Confronto visivo',
      en: 'Visual comparison',
      pt: 'Comparação visual',
   },
   visual_comparison_label: {
      context: 'lab-js/analyze-panel.js:143',
   ...
   baseline_thumbnail_alt: {
      context: 'lab-js/analyze-panel.js:137',
   ...
   current_thumbnail_alt: {
      context: 'lab-js/analyze-panel.js:150',
      it: 'Thumbnail volto attuale',
      en: 'Current face thumbnail',
      pt: 'Miniatura do rosto atual',
   },
   current_you_label: {
      context: 'lab-js/analyze-panel.js:151',
      it: 'Tu ora',
      en: 'You now',
      pt: 'Você agora',
   },
   face_detected_title: {
      context: 'lab-js/analyze-panel.js:167; lab-js/analyze-panel.js:194',
      it: 'Volto rilevato',
      en: 'Face detected',
      pt: 'Rosto detectado',
   },
   no_face_snapshot: {
      context: 'lab-js/analyze-panel.js:168; lab-js/analyze-panel.js:430',
   ...
   recognition_title: {
      context: 'lab-js/analyze-panel.js:171; lab-js/analyze-panel.js:206',
      it: 'Riconoscimento',
      en: 'Recognition',
      pt: 'Reconhecimento',
   },
   no_recognition_data: {
      context: 'lab-js/analyze-panel.js:172',
      it: 'Nessun dato di riconoscimento disponibile.',
      en: 'No recognition data available.',
      pt: 'Nenhum dado de reconhecimento disponível.',
   },
   no_id_found: {
      context: 'lab-js/analyze-panel.js:180',
      it: 'Nessun ID trovato',
      en: 'No ID found',
      pt: 'Nenhum ID encontrado',
   },
   estimated_age_label: {
      context: 'lab-js/analyze-panel.js:195',
      it: 'Eta stimata:',
      en: 'Estimated age:',
      pt: 'Idade estimada:',
   },
   predicted_gender_label: {
      context: 'lab-js/analyze-panel.js:197',
      it: 'Genere predetto:',
      en: 'Predicted gender:',
      pt: 'Gênero previsto:',
   },
   dominant_emotion_label: {
      context: 'lab-js/analyze-panel.js:199',
      it: 'Emozione dominante:',
      en: 'Dominant emotion:',
      pt: 'Emoção dominante:',
   },
   detection_confidence_label: {
      context: 'lab-js/analyze-panel.js:201; lab-js/analyze-panel.js:422',
   ...
   state_label: {
      context: 'lab-js/analyze-panel.js:207',
      it: 'Stato:',
      en: 'Status:',
      pt: 'Estado:',
   },
   match_with_id_label: {
      context: 'lab-js/analyze-panel.js:208; lab-js/analyze-panel.js:434',
      it: 'Match con ID:',
      en: 'Match with ID:',
   ...
   diversity_from_baseline_label: {
      context: 'lab-js/analyze-panel.js:209; lab-js/analyze-panel.js:436',
   ...
   recognition_threshold_label: {
      context: 'lab-js/analyze-panel.js:211; lab-js/analyze-panel.js:438',
      it: 'Soglia di riconoscimento:',
   ...
   interpretation_label: {
      context: 'lab-js/analyze-panel.js:213',
      it: 'Interpretazione:',
      en: 'Interpretation:',
      pt: 'Interpretação:',
   },
   ...
   analysis_explainer_age: {
      context: 'lab-js/analyze-panel.js:17',
   ...
   analysis_explainer_gender: {
      context: 'lab-js/analyze-panel.js:18',
   ...
   analysis_explainer_emotion: {
      context: 'lab-js/analyze-panel.js:19',
   ...
   analysis_explainer_confidence: {
      context: 'lab-js/analyze-panel.js:20',
   ...
   analysis_explainer_threshold: {
      context: 'lab-js/analyze-panel.js:22',
   ...
   analysis_explainer_embedder: {
      context: 'lab-js/analyze-panel.js:23',
   ...
   report_copy_failed_log: {
      context: 'lab-js/analyze-panel.js:232',
   ...
   report_title_markdown: {
      context: 'lab-js/analyze-panel.js:399; lab-js/analyze-panel.js:410',
      it: '### Ghostmaxxing - Analisi del trucco',
      en: '### Ghostmaxxing - Makeup analysis',
      pt: '### Ghostmaxxing - Análise da maquiagem',
   },
   yes_value: {
      context: 'lab-js/analyze-panel.js:412',
      it: 'si',
      en: 'yes',
      pt: 'sim',
   },
   no_value: {
      context: 'lab-js/analyze-panel.js:401; lab-js/analyze-panel.js:412',
      it: 'no',
      en: 'no',
      pt: 'não',
   },
   ...
   report_recognition_2d_heading: {
      context: 'lab-js/analyze-panel.js:403; lab-js/analyze-panel.js:426',
   ...
   no_baseline_face_database: {
      context: 'lab-js/analyze-panel.js:432',
   ...
   report_match_with_id_line: {
      context: 'lab-js/analyze-panel.js:434',
   ...
   report_diversity_line: {
      context: 'lab-js/analyze-panel.js:436',
   ...
   report_recognition_threshold_line: {
      context: 'lab-js/analyze-panel.js:438',
   ...
   report_status_line: {
      context: 'lab-js/analyze-panel.js:440',
      it: 'Stato: {value}',
      en: 'Status: {value}',
      pt: 'Estado: {value}',
   },
   report_embedder_3d_heading: {
      context: 'lab-js/analyze-panel.js:444',
   ...
   report_cosine_similarity_line: {
      context: 'lab-js/analyze-panel.js:447; lab-js/analyze-panel.js:449',
   ...
   no_embedding_data_available: {
      context: 'lab-js/analyze-panel.js:451',
   ...
   image_copied_log: {
      context: 'lab-js/export-makeup.js:49',
   ...
   image_shared_log: {
      context: 'lab-js/export-makeup.js:59',
   ...
   image_copy_unavailable_log: {
      context: 'lab-js/export-makeup.js:62',
   ...
   image_copy_error_log: {
      context: 'lab-js/export-makeup.js:66',
   ...
   plugin_missing_name_log: {
      context: 'lab-js/ghostyles-manager.js:101',
   ...
   plugin_invalid_release_date_log: {
      context: 'lab-js/ghostyles-manager.js:117',
   ...
   ghostyle_loaded_log: {
      context: 'lab-js/ghostyles-manager.js:143',
   ...
   plugin_runtime_error_log: {
      context: 'lab-js/ghostyles-manager.js:164; lab-js/plugins3d-loader.js:58',
   ...
   ghostyle_already_active_log: {
      context: 'lab-js/ghostyles-manager.js:348',
   ...
   ghostyle_switched_log: {
      context: 'lab-js/ghostyles-manager.js:367',
   ...
   ghostyle_activated_log: {
      context: 'lab-js/ghostyles-manager.js:369',
   ...
   updated_meta_label: {
      context: 'lab-js/ghostyles-manager.js:258',
      it: 'aggiornato {time}',
      en: 'updated {time}',
      pt: 'atualizado {time}',
   },
   pin_to_slot_title: {
      context: 'lab-js/ghostyles-manager.js:279; lab-js/ghostyles-manager.js:286',
   ...
   pin_ghostyle_to_slot_label: {
      context: 'lab-js/ghostyles-manager.js:280; lab-js/ghostyles-manager.js:287',
   ...
   params_heading: {
      context: 'lab-js/plugins3d-loader.js:373',
      it: 'Parametri - {name}',
      en: 'Parameters - {name}',
      pt: 'Parâmetros - {name}',
   },
   capture_thumbnail_video_required_error: {
      context: 'lab-js/face-thumbnails.js:154',
   ...
   capture_thumbnail_invalid_box_error: {
      context: 'lab-js/face-thumbnails.js:156',
   ...
   capture_thumbnail_frame_not_ready_error: {
      context: 'lab-js/face-thumbnails.js:162',
   ...
   capture_thumbnail_context_error: {
      context: 'lab-js/face-thumbnails.js:181',
   ...
   uv_path_required_error: {
      context: 'lab-js/ghostyle3d-uv-renderer.js:25',
   ...
   plugins3d_not_initialized_error: {
      context: 'lab-js/plugins3d-loader.js:92',
   ...
   plugins3d_missing_dom_error: {
      context: 'lab-js/plugins3d-loader.js:537',
   ...
   canvas_2d_context_error: {
      context: 'lab-js/export-makeup.js:178',
   ...
   uv_map_load_error_log: {
      context: 'lab-js/ghostyle3d-uv-renderer.js:59',
   ...
   console_bbox_overlay_missing: {
      context: 'lab-js/bbox-overlay.js:121',
   ...
   console_mediapipe_video_missing: {
      context: 'lab-js/mediapipe-loop.js:73',
   ...
   mediapipe_ready_log: {
      context: 'lab-js/mediapipe-loop.js:99',
   ...
   console_auto_find_tick_error: {
      context: 'lab-js/auto-find-loop.js:116',
   ...
   loader_record_face_button: {
      context: 'loader.html:64; lab-js/loader.js:250',
      it: 'Registra volto',
      en: 'Record face',
      pt: 'Gravar rosto',
   },
   loader_seek_face_button: {
      context: 'loader.html:65; lab-js/loader.js:303',
      it: 'Cerca volto',
      en: 'Seek face',
      pt: 'Buscar rosto',
   },
   ...
   loader_status_action_failed: {
      context: 'lab-js/loader.js:222',
      it: 'azione fallita',
      en: 'action failed',
      pt: 'ação falhou',
   },
   loader_status_loading_faceapi: {
      context: 'lab-js/loader.js:396',
   ...
   loader_model_error_log: {
      context: 'lab-js/loader.js:481',
      it: 'Errore modelli loader: {message}',
      en: 'Loader model error: {message}',
      pt: 'Erro de modelo do carregador: {message}',
   },
   loader_action_error: {
      context: 'lab-js/loader.js:223',
      it: 'errore',
      en: 'error',
      pt: 'erro',
   },
   loader_action_record_face: {
      context: 'lab-js/loader.js:231; lab-js/loader.js:250',
      it: 'registra volto',
      en: 'record face',
      pt: 'gravar rosto',
   },
   loader_action_seek_face: {
      context: 'lab-js/loader.js:286; lab-js/loader.js:303',
      it: 'cerca volto',
      en: 'seek face',
      pt: 'buscar rosto',
   },
   ...
   loader_chip_video: {
      context: 'lab-js/loader.js:147',
      it: 'video',
      en: 'video',
      pt: 'vídeo',
   },
   loader_no_face_result: {
      context: 'lab-js/loader.js:233; lab-js/loader.js:288',
      it: 'nessun volto rilevato',
      en: 'no face detected',
      pt: 'nenhum rosto detectado',
   },
   loader_no_2d_face_message: {
      context: 'lab-js/loader.js:234; lab-js/loader.js:289',
