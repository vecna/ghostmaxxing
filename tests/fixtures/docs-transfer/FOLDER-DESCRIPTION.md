...
| --- | --- |
| `before.png` | The source face before the Ghostyle is applied. |
| `after.png` | The same source face, pose, crop, and lighting after the Ghostyle is applied. |
| `target.png` | A different target frame or face that will receive the extracted pattern. |
