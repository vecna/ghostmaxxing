...
These files are excluded from code2prompt because they are test implementation detail, but the top-level `tests/FOLDER-DESCRIPTION.md` tells the chatbot the unit test suite exists and how it is run.
