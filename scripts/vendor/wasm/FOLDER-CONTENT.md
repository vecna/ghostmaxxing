...
The files come from the `@mediapipe/tasks-vision@0.10.35` package and are loaded by MediaPipe-backed face-landmarking and embedding code paths when the app runs locally.
